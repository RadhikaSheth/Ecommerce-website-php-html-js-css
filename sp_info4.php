<?php
  ...
  if(isset($_POST['addTOCart'])){
    ...
    $query2 = "INSERT INTO `cart`(`u_id`, `p_id`) VALUES ($row[0],'9')";
...
<div class="container-fluid h-100">
  <div class="row justify-content-center h-100">
    <div class="col-sm-6" style="background-color:#B5DFD6; height:600px">
      <br>
      <br>
      <br>
      <br>
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width:95%;align:center">
        ...
        <div class="carousel-inner" style="align:center;">
          <div class="item active">
            <img class="img-responsive center-block" src="img2.4.1.jpg" alt="Image1" style="width:70%;">
          </div>

          <div class="item">
              <img class="img-responsive center-block" src="img2.4.2.jpg" alt="Image2" style="width:70%;">
          </div>

          <div class="item">
            <img class="img-responsive center-block" src="img2.4.3.jpg" alt="Image3" style="width:70%;">
          </div>

          <div class="item">
            <img class="img-responsive center-block" src="img2.4.4.jpg" alt="Image4" style="width:70%;">
          </div>
    ...
    <div class="col-sm-6" style="background-color:#DBF5F0;height:600px " >

        <!-- product name -->
      <h2 >Sony SRS-XB01 Extra Bass Portable Wireless Speaker (White)</h2>
      <br>
      ...
      <br>
        <!-- Price-->
      <p >&nbsp &nbsp M.R.P.:&nbsp &nbsp<span style="text-decoration: line-through;"> <i class="fa fa-inr" aria-hidden="true"></i>2,990.00</span></p>
      <p>&nbsp &nbsp Price: &nbsp &nbsp &nbsp<i class="fa fa-inr" aria-hidden="true"></i>2,199.00</p>
      ...
      <ul style="width:600px " >
          <!-- Quick details -->
        <li>Bluetooth speakers made for electronic dance music (EDM)</li>
        <li>EXTRA BASS for deep and punchy sound</li>
        <li>Splashproof (IPX5 rated)</li>
        <li>One-touch listening with NFC and Bluetooth</li>
        <li>Up to 6 hours of battery life</li>
        <li>Built-in Mic for hands free calling</li>
  ...
  <table class="table table-hover center table-striped table-dark" style="width:900px">
    ...
    <tr>
      ...
      <td>	46.5 x 33 x 21 cm; 160 Grams</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>SONY INDIA PRIVATE LIMITED, A-18, Mohan Cooperative Industrial Estate, Mathura Road, New Delhi - 109913</td>
    </tr>
    <tr>
      <th scope="row">Included Components</th>
      <td>	Instruction Manual 1U, Reference Guide 1U, USB Cable 1U</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>#242,203 in Electronics (See Top 100 in Electronics)#2,601 in Bluetooth Speakers</td>
    </tr>
  </table>
</div>
</div>
