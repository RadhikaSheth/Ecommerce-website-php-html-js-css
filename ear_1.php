...
<body>
  <?php
    ...
    if(isset($_POST['addTOCart'])){
      ...
      $query2 = "INSERT INTO `cart`(`u_id`, `p_id`) VALUES ($row[0],'16')";
...
<div class="container-fluid h-100">
  <div class="row justify-content-center h-100">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width:95%;align:center">
        ...
        <div class="carousel-inner" style="align:center;">
          <div class="item active">
                <img class="img-responsive center-block" src="img4.1.1.jpg" alt="Image1" style="width:70%;">
          </div>

          <div class="item">
              <img class="img-responsive center-block" src="img4.1.2.jpg" alt="Image2" style="width:70%;">
          </div>
        </div>
    ...
    <div class="col-sm-6" style="background-color:#DBF5F0;height:620px " >
        ...
        <!-- product name -->
      <h2>Philips SHE2405PP/00 Upbeat inear Earphone with Mic (Purple)</h2>
      <br>
      ...
      <br>
        <!-- Price-->
      <p >&nbsp &nbsp M.R.P.:&nbsp &nbsp<span style="text-decoration: line-through;"> <i class="fa fa-inr" aria-hidden="true"></i>1,499.00</span></p>
      <p>&nbsp &nbsp Price: &nbsp &nbsp &nbsp<i class="fa fa-inr" aria-hidden="true"></i>669.00</p>
      ...
      <ul style="width:600px " >
          <!-- Quick details -->
        <li>Ergonomic slim-fit earbud</li>
        <li>8.6mm speaker drivers deliver clear sound and rich bass</li>
        <li>Neodymium magnets enhance bass performance</li>
        <li>Built-in mic switches from music to phone calls</li>
        <li>Oval tube to fit ear geometry for comfort</li>
        <li>3 interchangeable rubber ear caps offer an optimal fit</li>
      </ul>
    </div>
  </div>
  <div class="container-fluid h-100">
  ...
  <table class="table table-hover center table-striped table-dark" style="width:900px">
    ...
    <tr>
      ...
      <td>34.5 x 19.7 x 16.3 cm; 20 Grams</td>
    </tr>
    <tr>
      <th scope="row">Special Features</th>
      <td>Translucent housing for dual layer effect, With microphone</td>
    </tr>
    <tr>
